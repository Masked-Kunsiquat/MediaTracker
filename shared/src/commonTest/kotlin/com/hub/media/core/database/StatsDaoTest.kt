...
class StatsDaoTest {
    ...
    @Test
    fun observeTotalKnownDurationInRange_sumsOnlyNonNullDurations() =
        runTest {
            insertBook()
    ...
    @Test
    fun observeTotalKnownDurationInRange_emptyRange_isNull() =
        runTest {
            insertBook()
    ...
    @Test
    fun observeTotalKnownDurationInRange_allSessionsNullDuration_isNull() =
        runTest {
            insertBook()
            db.readingSessionDao().insert(
    ...
    @Test
    fun observeSessionCountInRange_countsAllSessionsIncludingNullDuration() =
        runTest {
            insertBook()
            db.readingSessionDao().insert(
    ...
    @Test
    fun observeSessionCountInRange_emptyRange_isZero() =
        runTest {
            insertBook()
    ...
    @Test
    fun observePagesReadInRange_sumsOnlyNonNullDeltaPages() =
        runTest {
            insertBook()
            db.readingSessionDao().insert(
    ...
    @Test
    fun observePagesReadInRange_emptyRange_isNull() =
        runTest {
            insertBook()
    ...
    @Test
    fun rangeBoundary_fromIsInclusive() =
        runTest {
            insertBook()
            db.readingSessionDao().insert(
    ...
    @Test
    fun rangeBoundary_toIsExclusive() =
        runTest {
            insertBook()
            db.readingSessionDao().insert(
    ...
    @Test
    fun observeSessionStartTimestampsInRange_returnsRawStartTimestamps() =
        runTest {
            insertBook()
    ...
    @Test
    fun observeBooksFinishedTotal_countsOnlyFinishedStatus() =
        runTest {
            insertBook()
    ...
    @Test
    fun observeBooksFinishedTotal_ignoresNonFinishedStatuses() =
        runTest {
            insertBook()
    ...
    @Test
    fun observeBooksFinishedInRange_respectsFinishedAtBounds_fromIsInclusive() =
        runTest {
            insertBook()
            db.bookDetailsDao().insert(
            ...
            val count =
                db
                    .statsDao()
                    .observeBooksFinishedInRange(ReadingStatus.FINISHED, instant(1_000), instant(2_000))
                    .first()
    ...
    @Test
    fun observeBooksFinishedInRange_respectsFinishedAtBounds_toIsExclusive() =
        runTest {
            insertBook()
            db.bookDetailsDao().insert(
    ...
    @Test
    fun observeBooksFinishedInRange_nullFinishedAt_neverMatches() =
        runTest {
            insertBook()
            ...
            val count =
                db
                    .statsDao()
                    .observeBooksFinishedInRange(ReadingStatus.FINISHED, instant(0), instant(999_999_999))
                    .first()
