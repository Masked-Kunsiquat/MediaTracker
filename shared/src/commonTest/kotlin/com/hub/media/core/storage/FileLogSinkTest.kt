...
class FileLogSinkTest {
    ...
    @Test
    fun log_bookLookupFailureFollowingTheIdentifierRule_persistsMediaIdButNeverTitleOrAuthor() =
        runTest {
    ...
    @Test
    fun log_withThrowable_foldsStackTraceIntoMessage_beforeReachingTheStore() =
        runTest {
    ...
    @Test
    fun log_neverThrows_evenWhenTheUnderlyingStoresClockThrows() =
        runTest {
            ...
            assertTrue(
                persisted.isEmpty(),
                "append() must not have buffered anything when the clock threw -- found: $persisted",
            )
