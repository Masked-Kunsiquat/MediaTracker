...
class LruCacheTest {
    ...
    @Test
    fun evictsTheOldestEntryOnceFull() =
        runTest {
    ...
    @Test
    fun readingAnEntryMakesItSurviveTheNextEviction() =
        runTest {
    ...
    @Test
    fun overwritingAKeyRefreshesItsRecency() =
        runTest {
            val cache = LruCache<String, Int>(maxSize = 2)
    ...
    @Test
    fun zeroOrNegativeMaxSize_isClampedToAUsableCache() =
        runTest {
    ...
    @Test
    fun concurrentWrites_allLandAndRespectTheBound() =
        runTest {
