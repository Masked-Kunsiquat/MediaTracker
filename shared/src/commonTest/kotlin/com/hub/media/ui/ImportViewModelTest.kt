...
class ImportViewModelTest {
    ...
    private fun newViewModel(useCase: ImportUseCase) =
        viewModels.track(ImportViewModel(useCase))

    private val sampleSummary = ImportSummary(
        booksImported = 2, booksSkipped = 1, booksMerged = 0, booksReplaced = 0,
        sessionsImported = 3, sessionsSkipped = 0, sessionsMerged = 0, sessionsReplaced = 0,
    ...
    @Test
    fun importData_emitsIdleThenLoadingThenSuccess() = runTest {
    ...
    @Test
    fun importData_useCaseError_setsErrorState() = runTest {
    ...
    @Test
    fun importData_concurrentRequestWhileLoading_isIgnored() = runTest {
    ...
    @Test
    fun importData_afterReset_isAcceptedAgain() = runTest {
