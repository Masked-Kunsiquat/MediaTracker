...
class StatsRepositoryTest {
    ...
    @Test
    fun observeTimeReadInRange_excludesNullDurationSessions() =
        runTest {
            insertBook()
    ...
    @Test
    fun observeTimeReadInRange_emptyRange_isNullNotZero() =
        runTest {
            insertBook()
    ...
    @Test
    fun observeSessionCountInRange_countsNullDurationSessionsToo() =
        runTest {
            insertBook()
            insertSession(instant(1_100), durationSeconds = 100)
            insertSession(instant(1_200), durationSeconds = null)
    ...
    @Test
    fun observePagesReadInRange_ignoresNullDeltaPages() =
        runTest {
            insertBook()
    ...
    @Test
    fun observePagesReadInRange_emptyRange_isNullNotZero() =
        runTest {
            insertBook()
    ...
    @Test
    fun rangeBoundary_fromInclusive_toExclusive() =
        runTest {
            insertBook()
    ...
    private fun utcDay(
        epochDay: Long,
        hour: Int = 12,
    ): Instant = Instant.fromEpochMilliseconds(epochDay * 86_400_000L + hour * 3_600_000L)

    @Test
    fun observeReadingStreak_threeConsecutiveDays_streakIsThree() =
        runTest {
            insertBook()
    ...
    @Test
    fun observeReadingStreak_gapBreaksStreak() =
        runTest {
            insertBook()
            insertSession(utcDay(100))
            insertSession(utcDay(99))
    ...
    @Test
    fun observeReadingStreak_todayWithoutSessionYet_keepsYesterdaysStreak() =
        runTest {
            insertBook()
    ...
    @Test
    fun observeReadingStreak_noSessions_isZero() =
        runTest {
            insertBook()
    ...
    @Test
    fun observeReadingStreak_singleSessionToday_isOne() =
        runTest {
            insertBook()
            insertSession(utcDay(100))
    ...
    @Test
    fun observeReadingStreak_neitherTodayNorYesterdayHasSession_isZero() =
        runTest {
            insertBook()
     ...
     */
    @Test
    fun observeReadingStreak_lateEveningSession_bucketedByLocalDateNotUtc() =
        runTest {
            insertBook()
    ...
    @Test
    fun observeBooksFinishedTotal_countsFinishedBooksAcrossAllTime() =
        runTest {
            insertBook()
    ...
    @Test
    fun observeBooksFinishedTotal_zeroWhenNoBookIsFinished() =
        runTest {
            insertBook()
    ...
    @Test
    fun observeBooksFinishedInRange_onlyCountsFinishesWithinBounds() =
        runTest {
            insertBook()
            db.bookDetailsDao().insert(
                sampleBookDetails(mediaId = mediaId, status = ReadingStatus.FINISHED, finishedAt = instant(1_500)),
