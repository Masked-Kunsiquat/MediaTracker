...
class BookRepositoryTest {
    ...
    @Test
    fun addBook_whenTheWriteFails_logsTheCauseWithoutTheTitle() =
        runTest {
    ...
    @Test
    fun updateReadingStatus_whenTheWriteFails_logsTheOpaqueIdOnly() =
        runTest {
            val recorder = RecordingLogger()
            val repo = BookRepository(db, logger = recorder)
            val id = newId()
    ...
    @Test
    fun addBook_whenCancelled_rethrowsAndLogsNothing() =
        runTest {
    ...
    @Test
    fun addBook_happyPath_insertsAllRows() =
        runTest {
            val result =
                repo.addBook(
    ...
    @Test
    fun addBook_withExternalIdentifiers_insertsAll() =
        runTest {
            val result =
                repo.addBook(
                    title = "Clean Code",
    ...
    @Test
    fun addBook_duplicateProviderPair_rollsBackWholeTransaction() =
        runTest {
    ...
    @Test
    fun observeBook_emitsBookThenNullAfterDelete() =
        runTest {
    ...
    @Test
    fun observeAllBooks_emitsAfterInsert() =
        runTest {
    ...
    @Test
    fun deleteBook_cascadesAllData() =
        runTest {
            val mediaId = newId()
    ...
    @Test
    fun observeBookDetail_emitsMediaItemAndDetailsForInsertedBook() =
        runTest {
            val result =
                repo.addBook(
    ...
    @Test
    fun observeBookDetail_emitsNullAfterDelete() =
        runTest {
    ...
    @Test
    fun observeBookDetail_mediaItemWithNoBookDetailsRow_emitsDetailsNull() =
        runTest {
    ...
    @Test
    fun updateBookMetadata_happyPath_updatesBothTablesAndObserveBookDetailEmitsNewValues() =
        runTest {
            val addResult =
                repo.addBook(
    ...
    @Test
    fun updateBookMetadata_nullTotalPages_isValidAndPersists() =
        runTest {
    ...
    @Test
    fun updateBookMetadata_blankTitle_rejectedAndPersistsNothing() =
        runTest {
            val addResult =
                repo.addBook(
    ...
    @Test
    fun updateBookMetadata_negativePurchasePrice_rejectedAndPersistsNothing() =
        runTest {
    ...
    @Test
    fun updateBookMetadata_nonFinitePurchasePrice_rejectedAndPersistsNothing() =
        runTest {
    ...
    @Test
    fun updateBookMetadata_zeroTotalPages_rejectedAndPersistsNothing() =
        runTest {
    ...
    @Test
    fun updateBookMetadata_negativeTotalPages_rejectedAndPersistsNothing() =
        runTest {
            val addResult = repo.addBook(title = "Book", totalPages = 250, format = BookFormat.PHYSICAL)
            assertIs<Resource.Success<String>>(addResult)
            val mediaId = addResult.data
    ...
    @Test
    fun updateBookMetadata_releaseYearTooLow_rejectedAndPersistsNothing() =
        runTest {
    ...
    @Test
    fun updateBookMetadata_releaseYearTooHigh_rejectedAndPersistsNothing() =
        runTest {
            val addResult = repo.addBook(title = "Book", releaseYear = 2000, format = BookFormat.PHYSICAL)
            assertIs<Resource.Success<String>>(addResult)
            val mediaId = addResult.data
    ...
    @Test
    fun updateBookMetadata_unknownMediaId_returnsError() =
        runTest {
            val result =
                repo.updateBookMetadata(
                    mediaId = newId(),
    ...
    @Test
    fun updateBookMetadata_noExistingBookDetailsRow_insertsNewRowAndUpdatesMediaItem() =
        runTest {
    ...
    @Test
    fun updateBookMetadata_transitionToFinished_stampsFinishedAt() =
        runTest {
    ...
    @Test
    fun updateBookMetadata_reSavingAlreadyFinished_preservesOriginalFinishedAt() =
        runTest {
    ...
    @Test
    fun updateBookMetadata_transitionAwayFromFinished_clearsFinishedAt() =
        runTest {
    ...
    @Test
    fun updateReadingStatus_happyPath_updatesStatusOnly() =
        runTest {
    ...
    @Test
    fun updateBookMetadata_transitionToFinished_usesInjectedClockNotSystemClock() =
        runTest {
            ...
            val result =
                repoWithFixedClock.updateBookMetadata(
                    mediaId = mediaId,
                    title = "Clocked Book",
                    format = BookFormat.PHYSICAL,
                    status = ReadingStatus.FINISHED,
    ...
    @Test
    fun updateReadingStatus_toFinished_stampsFinishedAt() =
        runTest {
    ...
    @Test
    fun updateReadingStatus_unknownMediaId_returnsError() =
        runTest {
    ...
    @Test
    fun addBook_duplicateIsbn_doesNotCrash() =
        runTest {
            // First book
            val result1 =
                repo.addBook(
    ...
    @Test
    fun addBook_knownTotalPages_defaultsTrackingModeToPages() =
        runTest {
    ...
    @Test
    fun addBook_unknownTotalPages_defaultsTrackingModeToPercent() =
        runTest {
    ...
    @Test
    fun addBook_explicitTrackingModeOverridesTotalPagesDerivedDefault() =
        runTest {
    ...
    @Test
    fun updateBookMetadata_trackingModePages_persistsAndReadsBack() =
        runTest {
    ...
    @Test
    fun updateBookMetadata_trackingModePercent_persistsIndependentlyOfTotalPages() =
        runTest {
    ...
    @Test
    fun applyBackfilledMetadata_writesCoverAndAuthorsAtomically() =
        runTest {
            val addResult =
                repo.addBook(
    ...
    @Test
    fun applyBackfilledMetadata_coverOnly_leavesAuthorsUntouched() =
        runTest {
    ...
    @Test
    fun applyBackfilledMetadata_authorsOnly_leavesCoverUntouched() =
        runTest {
            val addResult =
                repo.addBook(
    ...
    @Test
    fun applyBackfilledMetadata_bothNull_isNoOpSuccess() =
        runTest {
    ...
    @Test
    fun applyBackfilledMetadata_unknownMediaId_returnsError() =
        runTest {
    ...
    @Test
    fun getAllBooksWithDetails_returnsEveryBookJoinedWithDetails() =
        runTest {
    ...
    @Test
    fun getAllBooksWithDetails_returnsResultsOrderedByTitle() =
        runTest {
    ...
    @Test
    fun getAllBooksWithDetails_includesBookWithNullDetailsWhenNoBookDetailsRow() =
        runTest {
            val mediaId = newId()
