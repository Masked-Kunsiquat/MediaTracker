...
class LogReadingSessionUseCaseTest {
    ...
    private suspend fun noSessionsPersisted(): Boolean = repository.observeSessionsForMedia(mediaId).first().isEmpty()

    @Test
    fun execute_timerResultOverload_happyPath_persistsSession() =
        runTest {
    ...
    @Test
    fun execute_explicitBoundsOverload_happyPath_persistsSession() =
        runTest {
    ...
    @Test
    fun execute_explicitBoundsOverload_nullDuration_persistsWithNullDuration() =
        runTest {
    ...
    @Test
    fun execute_negativeStartUnit_returnsErrorAndPersistsNothing() =
        runTest {
    ...
    @Test
    fun execute_negativeEndUnit_returnsErrorAndPersistsNothing() =
        runTest {
            val timerResult = ReadingTimerResult(start, start.plus(Duration.parse("1m")), 60)
    ...
    @Test
    fun execute_endUnitLessThanStartUnit_isAllowed_rereadIsNotAnError() =
        runTest {
    ...
    @Test
    fun execute_zeroSecondZeroPageSession_isAllowed() =
        runTest {
    ...
    @Test
    fun execute_nanStartUnit_returnsErrorAndPersistsNothing() =
        runTest {
    ...
    @Test
    fun execute_nanEndUnit_returnsErrorAndPersistsNothing() =
        runTest {
            val timerResult = ReadingTimerResult(start, start.plus(Duration.parse("1m")), 60)
    ...
    @Test
    fun execute_positiveInfinityStartUnit_returnsErrorAndPersistsNothing() =
        runTest {
            val timerResult = ReadingTimerResult(start, start.plus(Duration.parse("1m")), 60)
    ...
    @Test
    fun execute_positiveInfinityEndUnit_returnsErrorAndPersistsNothing() =
        runTest {
            val timerResult = ReadingTimerResult(start, start.plus(Duration.parse("1m")), 60)
    ...
    @Test
    fun executeUpdate_happyPath_persistsChanges() =
        runTest {
            val timestampEnd = start.plus(Duration.parse("1h"))
            val createResult =
                useCase.execute(
    ...
    @Test
    fun executeUpdate_negativeStartUnit_returnsErrorAndLeavesRowUnchanged() =
        runTest {
            val timestampEnd = start.plus(Duration.parse("1h"))
            val createResult =
                useCase.execute(
    ...
    @Test
    fun executeUpdate_nanEndUnit_returnsErrorAndLeavesRowUnchanged() =
        runTest {
    ...
    @Test
    fun executeUpdate_endUnitLessThanStartUnit_isAllowed_rereadIsNotAnError() =
        runTest {
            val timestampEnd = start.plus(Duration.parse("1h"))
            val createResult =
                useCase.execute(
    ...
    @Test
    fun executeUpdate_nonexistentSessionId_returnsError() =
        runTest {
            val updateResult =
                useCase.executeUpdate(
                    sessionId = newId(),
    ...
    @Test
    fun executeUpdate_invalidTimestamps_propagatesRepositoryErrorAndLeavesRowUnchanged() =
        runTest {
            val timestampEnd = start.plus(Duration.parse("1h"))
            val createResult =
                useCase.execute(
    ...
    @Test
    fun execute_invalidTimestamps_propagatesRepositoryErrorAndPersistsNothing() =
        runTest {
