...
class ReadingSessionRepositoryTest {
    ...
    @Test
    fun logSession_whenTheWriteFails_recordsTheCauseAgainstTheOpaqueId() =
        runTest {
    ...
    @Test
    fun logSession_happyPath_injectsValidSession() =
        runTest {
    ...
    @Test
    fun logSession_zeroSeconds_succeeds() =
        runTest {
    ...
    @Test
    fun logSession_nullDuration_persistsWithNullDuration() =
        runTest {
    ...
    @Test
    fun logSession_negativePages_succeeds() =
        runTest {
    ...
    @Test
    fun logSession_invalidEndBeforeStart_returnsError() =
        runTest {
            val now = Clock.System.now()
    ...
    @Test
    fun logSession_negativeDuration_returnsError() =
        runTest {
            val now = Clock.System.now()
    ...
    @Test
    fun observeSessionsForMedia_emitsAfterInsert() =
        runTest {
            val now = Clock.System.now()
    ...
    @Test
    fun observeSessionsForMedia_differentiatesByMediaId() =
        runTest {
            val mediaId2 = newId()
    ...
    @Test
    fun updateSession_happyPath_persistsAllFields() =
        runTest {
            val timestampStart = Instant.fromEpochMilliseconds(1_700_000_000_000)
            val timestampEnd = Instant.fromEpochMilliseconds(1_700_000_600_000)
            val addResult =
    ...
    @Test
    fun updateSession_nullDuration_persistsWithNullDuration() =
        runTest {
            val now = Clock.System.now()
            val addResult =
                repo.logSession(
    ...
    @Test
    fun updateSession_invalidEndBeforeStart_returnsErrorAndLeavesRowUnchanged() =
        runTest {
            val now = Clock.System.now()
            val addResult =
                repo.logSession(
    ...
    @Test
    fun updateSession_negativeDuration_returnsErrorAndLeavesRowUnchanged() =
        runTest {
            val now = Clock.System.now()
            val addResult =
                repo.logSession(
    ...
    @Test
    fun readingSessionDao_update_returnsZeroRowsAffectedWhenRowVanishedMidFlight() =
        runTest {
    ...
    @Test
    fun updateSession_happyPath_updateReportsOneRowAffected() =
        runTest {
    ...
    @Test
    fun updateSession_nonexistentId_returnsError() =
        runTest {
            val now = Clock.System.now()
