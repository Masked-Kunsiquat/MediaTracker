...
class SettingsRepositoryTest {
    ...
    @Test
    fun setString_differentKeys_doNotCollide() = runTest {
    ...
    @Test
    fun setInt_thenGetInt_roundTripsExactly() = runTest {
        repo.setInt("week_start_day_ordinal", 1)
        assertEquals(1, repo.getInt("week_start_day_ordinal"))
    }

    @Test
    fun getInt_malformedStoredValue_isNullNotThrow() = runTest {
        repo.setString("not_a_number", "abc")
        assertNull(repo.getInt("not_a_number"))
    }

    @Test
    fun setBoolean_thenGetBoolean_roundTripsExactly() = runTest {
    ...
    @Test
    fun getBoolean_malformedStoredValue_isNullNotThrow() = runTest {
        repo.setString("not_a_boolean", "maybe")
        assertNull(repo.getBoolean("not_a_boolean"))
    }

    @Test
    fun clear_removesKey_revertsToNull() = runTest {
