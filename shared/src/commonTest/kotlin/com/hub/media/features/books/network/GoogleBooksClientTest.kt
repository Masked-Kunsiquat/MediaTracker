...
class GoogleBooksClientTest {
     ...
     */
    @Test
    fun imageLinks_allSizesPresent_selectsExtraLarge() = runTest {
        val responseJson = """
            {
              "totalItems": 1,
              "items": [
    ...
    @Test
    fun imageLinks_onlyMediumAndSmallerPresent_fallsBackToMedium() = runTest {
        val responseJson = """
            {
              "totalItems": 1,
              "items": [
    ...
    @Test
    fun imageLinks_onlyThumbnailPresent_fallsBackToThumbnail() = runTest {
    ...
    @Test
    fun imageLinks_onlySmallThumbnailPresent_fallsBackToSmallThumbnail() = runTest {
        val responseJson = """
            {
              "totalItems": 1,
              "items": [
    ...
    @Test
    fun imageLinks_allSizesAbsent_coverImageUrlIsNull() = runTest {
        val responseJson = """
            {
              "totalItems": 1,
              "items": [
