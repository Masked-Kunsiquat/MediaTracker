...
class SearchBooksUseCaseTest {
    ...
    private companion object {
        fun hit(title: String) = BookSearchResult(
            title = title,
    ...
    @Test
    fun query_shorterThanTheMinimum_neverReachesTheNetwork() = runTest {
    ...
    @Test
    fun whitespaceOnlyPadding_doesNotFakeUpTheMinimumLength() = runTest {
    ...
    @Test
    fun query_atTheMinimum_isSearched() = runTest {
        val provider = RecordingProvider()
        val useCase = SearchBooksUseCase(provider)
    ...
    @Test
    fun repeatedQuery_isServedFromCacheWithoutASecondRequest() = runTest {
    ...
    @Test
    fun queriesDifferingOnlyInCaseOrSpacing_shareOneRequest() = runTest {
        val provider = RecordingProvider()
        val useCase = SearchBooksUseCase(provider)
    ...
    @Test
    fun errors_areNotCached() = runTest {
        ...
        var attempt = 0
        val provider = RecordingProvider { query ->
            attempt++
    ...
    @Test
    fun emptyResults_areCached() = runTest {
    ...
    @Test
    fun leastRecentlyUsedQuery_isEvictedFirst() = runTest {
        val provider = RecordingProvider()
    ...
    @Test
    fun cancellation_propagatesRatherThanBecomingAnError() = runTest {
    ...
    @Test
    fun cancelledSearch_isNotCached() = runTest {
    ...
    @Test
    fun limit_isForwardedToTheProvider() = runTest {
        val provider = RecordingProvider()
    ...
    @Test
    fun isQueryLongEnough_matchesWhatExecuteActuallyDoes() = runTest {
