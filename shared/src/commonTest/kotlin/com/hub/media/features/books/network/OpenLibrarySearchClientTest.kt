...
class OpenLibrarySearchClientTest {
    ...
    @Test
    fun happyPath_mapsEveryFieldADropdownRowNeeds() =
        runTest {
    ...
    @Test
    fun request_asksForAWhitelistOfFieldsAndNeverForIsbn() =
        runTest {
    ...
    @Test
    fun query_isTrimmedAndUrlEncoded() =
        runTest {
            var request: HttpRequestData? = null
            val engine =
                MockEngine { req ->
    ...
    @Test
    fun blankQuery_shortCircuitsWithoutSpendingARequest() =
        runTest {
            var calls = 0
            val engine =
                MockEngine {
    ...
    @Test
    fun emptyDocs_isASuccessfulSearchThatFoundNothing() =
        runTest {
    ...
    @Test
    fun docWithoutTitle_isDroppedWithoutFailingTheWholeSearch() =
        runTest {
            val json =
                """
                {
    ...
    @Test
    fun sparseDoc_survivesWithNullsRatherThanFailing() =
        runTest {
    ...
    @Test
    fun blankAuthorNames_areDropped() =
        runTest {
    ...
    @Test
    fun rateLimited_surfacesTheStatusAndLogsIt() =
        runTest {
    ...
    @Test
    fun malformedJson_isAnErrorNotACrash() =
        runTest {
            val logger = RecordingLogger()
    ...
    @Test
    fun networkFailure_isAnErrorNotACrash() =
        runTest {
            val logger = RecordingLogger()
    ...
    @Test
    fun failure_logsTheExceptionTypeAndNeverTheSearchQuery() =
        runTest {
    ...
    @Test
    fun malformedJsonFailure_alsoWithholdsTheQuery() =
        runTest {
            val logger = RecordingLogger()
            val engine = MockEngine { jsonResponse("{ this is not json") }
            val client = OpenLibrarySearchClient(createHttpClient(engine), logger)
    ...
    @Test
    fun cancellation_propagatesAndIsNotLoggedAsAProviderFailure() =
        runTest {
    ...
    @Test
    fun limit_isPassedThroughRatherThanHardcoded() =
        runTest {
            var request: HttpRequestData? = null
            val engine =
                MockEngine { req ->
