...
fun EditMovieScreen(
    ...
    Scaffold(
        // Same reasoning as AddMovieScreen: Scaffold's default insets don't cover the IME, so
        // without safeDrawing the keyboard would sit over these fields instead of the layout
        // resizing.
